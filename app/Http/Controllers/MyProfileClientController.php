...
class MyProfileClientController extends Controller
{
    ...
    public function manage(){
        $datas = OurClient::orderBy('order')->get();
        $compact = compact('datas');
        return view('our_client.manage')->with($compact);
    }

    public function viewEdit($id)
    {
        $data = OurClient::where('id', '=', $id)->first();
        return view('our_client.edit')->with(compact('data'));
    }

    public function update(Request $request)
    {
        $object = OurClient::findOrFail($request->id);
