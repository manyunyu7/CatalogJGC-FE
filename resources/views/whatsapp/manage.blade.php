        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Whatsapp</h3>
                    <p class="text-subtitle text-muted">Gunakan Menu ini untuk mengatur whatsapp yang akan ditampilkan pada halaman website</p>
                </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Manage Whatsapp</h4>
                    </div>
...
{{--                                                <th data-sortable=""></th>--}}
                                                <th data-sortable="">Nama Kontak</th>
                                                <th data-sortable="">Nomor</th>
...
{{--                                                    </td>--}}
                                                    ...
                                                    <td>
                                                        <a href="{{url('company-profile/whatsapp/'.$item->id.'/edit')}}">
...
@push('script')
    ...
    <script type="text/javascript">
        ...
        $('body').on("click", ".btn-delete", function() {
            var id = $(this).attr("id")
            $(".btn-destroy").attr("href", window.location.origin + "/company-profile/whatsapp/" + id + "/delete")
