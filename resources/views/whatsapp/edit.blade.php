        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Edit Data</h3>
                    <p class="text-subtitle text-muted">Gunakan Menu ini untuk mengatur data whatsapp di profile</p>
                </div>
...
@section('page-content')
    ...
    <section class="section">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ url('company-profile/whatsapp/update') }}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control"
                                       value="{{ old('name',$data->name) }}" required id="basicInput"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="contact" class="form-control"
                                       value="{{ old('contact',$data->contact) }}" required id="basicInput"
                            ...
                            <div class="form-group">
                                ...
                                <textarea style="height: 250px" name="description" class="form-control" id="basicInput" placeholder="Deskripsi">{{ old('description',$data->description) }}</textarea>
