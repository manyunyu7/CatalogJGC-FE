            ...
            <div class="modal-content">
                <div class="modal-header bg-danger">
                    <h5 class="modal-title white" id="myModalLabel120">
                        Anda Yaking Ingin Menghapus Data Slider Ini ?
                    </h5>
                ...
                <div class="modal-body">
                    Data Slider terkait akan dihapus.
                </div>
...
@push('script')
    ...
    <script type="text/javascript">
        ...
        $('body').on("click", ".btn-delete", function() {
            var id = $(this).attr("id")
            $(".btn-destroy").attr("href", window.location.origin + "/company-profile/slider/" + id + "/delete")
