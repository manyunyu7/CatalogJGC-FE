        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Edit Data</h3>
                    <p class="text-subtitle text-muted">Gunakan Menu ini untuk mengatur data brand di profile</p>
                </div>
...
@section('page-content')
    ...
    <section class="section">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ url('company-profile/brand/update') }}" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <img src='{{asset("$data->image")}}' style="border-radius: 20px; max-height: 200px" id="imgPreview" class="img-fluid" alt="Responsive image">
                            ...
                            <img src='{{asset("$data->poster")}}' style="border-radius: 20px; max-height: 200px" id="imgPreviewPoster" class="img-fluid" alt="Responsive image">
