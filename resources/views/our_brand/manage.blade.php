        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Brand Kami</h3>
                    <p class="text-subtitle text-muted">Gunakan Menu ini untuk mengatur daftar brand di halaman profile</p>
                </div>
                                        ...
                                        <tbody>
                                            @forelse ($datas as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url('company-profile/brand/'.$item->id.'/edit')}}">
...
@push('script')
    ...
    <script type="text/javascript">
        ...
        $('body').on("click", ".btn-delete", function() {
            var id = $(this).attr("id")
            $(".btn-destroy").attr("href", window.location.origin + "/company-profile/brand/" + id + "/delete")
